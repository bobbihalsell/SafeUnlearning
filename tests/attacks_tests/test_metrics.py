...
class TestImageComparisonFunctions(unittest.TestCase):
    def setUp(self):
        ...
        self.img_batch = [torch.rand(self.channels, 24, 24) for _ in range(self.batch_size)]
        self.ref_batch = [torch.rand(self.channels, 24, 24) for _ in range(self.batch_size)]
    ...
    def test_apply_resizing(self):
        ...
        # Check output shapes
        self.assertEqual(resized_img.shape, (self.batch_size, self.channels, self.height, self.width))
        self.assertEqual(resized_ref.shape, (self.batch_size, self.channels, self.height, self.width))
        ...
        self.assertEqual(resized_varied_img.shape, (self.batch_size, self.channels, self.height, self.width))
        self.assertEqual(resized_varied_ref.shape, (self.batch_size, self.channels, self.height, self.width))
