...
class TrainApp(TrainValidator):
    ...
    def reinitialize_checkpoints(self, model, optimizer):
        ...
        if self.from_checkpoint:
            ...
            raise Exception(
                "reinitialize_checkpoint_states should not be "
    ...
    def pretrain(self):
        ...
        self._eval_initial_model(criterion, model, train_dl, val_dl)
