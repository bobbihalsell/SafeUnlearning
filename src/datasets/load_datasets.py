...
def download_cifar_datasets(
    ...
    if dataset_name == "cifar10":
        raw_train = datasets.CIFAR10(
            root=download_root, train=True, download=True, transform=transform
        )
        raw_test = datasets.CIFAR10(
            root=download_root, train=False, download=True, transform=transform
        )
...
def save_cifar_as_imagefolder(raw_train, raw_test, download_root, dataset_save_dir):
    """
