...
class GGLReconstructor:
    ...
    def evaluate_loss(self, z, labels, loss_type=None, steps=None, **kwargs):
        ...
        # Compute difference between model from reconstruction and unlearned
            ...
            loss = self.compute_model_difference_weighted(
                recon, self.target_model
            )
        elif loss_type == 'l2':
    ...
    def generate_image(self, z, labels):
        ...
        c = torch.nn.functional.one_hot(
            label_tensor, num_classes=self.num_classes
    ...
    def reconstruct(self, **kwargs):
        ...
        f = lambda z: self.evaluate_loss(
            z, labels, loss_type=self.type, **kwargs
        )
