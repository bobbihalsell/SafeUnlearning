...
from attacks.GGL.projection import projection_attack_set_up, projection_attack
...
class GGLReconstructor:
    ...
    def __init__(
        ...
        Args:
            ...
            variance_threshold: The threshold for variance explained by the subspace for projection
        ...
        target_projection, subspace = projection_attack_set_up(self.original_model, self.target_model, bdata_loader, self.lr, self.device, self.variance_threshold)
