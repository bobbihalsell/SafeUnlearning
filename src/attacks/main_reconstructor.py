...
class ReconstructorApp(ReconstructorValidator):
    ...
    def initalise_image_params(self):
        ...
        self.image_mean, self.image_std, self.image_size = DATASETS_TO_PARAMS[
            self.dataset_name
        ]
    ...
    def initialize_reconstructor(self, unlearned_model, original_model):
        ...
        if self.attack_name == "ggl":
            ...
            raise ValueError(f"reconstructor {self.attack_name} not supported.")
    ...
    def run(self):
        ...
        reconstructor = self.initialize_reconstructor(
            self.unlearned_model, self.original_model
        )
        ...
        if self.attack_name == "ggl":
            ...
            reconstruction, losses = reconstructor.reconstruct(
                labels=self.labels,
